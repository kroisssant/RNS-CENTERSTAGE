...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = -2.55; // X is the up and down direction
    public static double PARALLEL_Y = 0.5; // Y is the strafe direction

    public static double PERPENDICULAR_X =  -4.45;
    ...
    public List<Double> getWheelPositions() {
        return Arrays.asList(
                encoderTicksToInches(parallelEncoder.getCurrentPosition() * 0.5088396969246769),
                encoderTicksToInches(perpendicularEncoder.getCurrentPosition() *0.5146231721034871)
        );
    }
