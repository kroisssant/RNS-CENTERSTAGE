...
@Config
@Autonomous
public class autoSafeProstuPunePeDreaptaDeparteRed extends LinearOpMode {
    Intake intake;
    OutTake outtake;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory galbenDreapta3 = drive.trajectoryBuilder(galbenDreapta2.end())
                        .lineToConstantHeading(new Vector2d(36, -92)).build();;
        ...
        Trajectory galbenStanga3 = drive.trajectoryBuilder(galbenStanga2.end())
                .lineToLinearHeading(new Pose2d(28, -92, Math.toRadians(+90))).build();
        ...
        Trajectory galben4 = drive.trajectoryBuilder(galben3.end())
                        .lineToConstantHeading(new Vector2d(20, -100)).build();
