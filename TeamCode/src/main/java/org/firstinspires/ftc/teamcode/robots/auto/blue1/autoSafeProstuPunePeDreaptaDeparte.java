...
@Config
@Autonomous
public class autoSafeProstuPunePeDreaptaDeparte extends LinearOpMode {
    IntakeOld intake;
    OutTakeOld outtake;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory movStanga = drive.trajectoryBuilder(new Pose2d(0, 0 ,0))
                        .lineToLinearHeading(new Pose2d(24, 6, Math.toRadians(90))).build();
        ...
        Trajectory galben4 = drive.trajectoryBuilder(galben3.end())
                        .lineToConstantHeading(new Vector2d(16, 100)).build();
